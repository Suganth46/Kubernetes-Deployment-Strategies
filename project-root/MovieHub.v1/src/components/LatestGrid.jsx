export default function LatestGrid({ list }) {
  return (
    <section className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <h3 className="text-2xl font-semibold text-white">Hollywood Classics</h3>
          <p className="text-sm text-slate-300">
            Original releases with trailers and ratings.
          </p>
        </div>
          ...
          >
            ...
            <div className="flex flex-1 flex-col gap-4 p-5">
              <div className="space-y-2">
                ...
                <p className="text-sm text-slate-300">{movie.blurb}</p>
              </div>
              ...
              <div className="flex flex-wrap items-center justify-between gap-3 text-xs uppercase tracking-[0.2em] text-slate-300">
